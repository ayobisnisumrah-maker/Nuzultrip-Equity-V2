...
export const INITIAL_INVOICES: OfficialInvoice[] = [
  {
    id: '623f5ca5-9446-489a-8bd0-22f7614c8a9a',
    invoiceNumber: 'INV-20260918-3413CF982BF3',
    title: 'Bukti Pembayaran Umrah 9 Hari',
    customerName: 'Badan Pendapatan Daerah Provinsi Sulawesi Selatan',
    customerEmail: 'bapenda.sulsel@pemprov.go.id',
    customerPhone: '+62 811-445-8890',
    customerAddress: 'Jl. Urip Sumoharjo No. 269, Sinrijala, Kec. Panakkukang, Kota Makassar, Sulawesi Selatan 90231',
    dueDate: '22/09/2026',
    departureDate: '25/10/2026',
    packageCode: 'PKT-D814659D',
    packageName: 'Paket Umrah',
    packageDescription: 'Umrah 9 Hari\nPKT-D814659D',
    paxCount: 3,
    pricePerPax: 36800000,
    discount: 0,
    taxRate: 0,
    subtotal: 110400000,
    taxAmount: 0,
    totalAmount: 110400000,
    paidAmount: 0,
    remainingAmount: 110400000,
    paymentStatus: 'draft',
    paymentMethodDetails: 'Belum ada pembayaran',
    notes: 'Pemesanan grup dinas Bapenda Sul-Sel untuk keberangkatan musim gugur 2026.',
    createdAt: '18 September 2026',
    termsAndConditions: '', // Populated by default terms
  },
  {
    id: '8a9d123c-1122-44aa-99bb-4411ee33aa11',
    invoiceNumber: 'INV-20260918-E38568204C91',
    title: 'Bukti Pembayaran Umrah 9 Hari',
    customerName: 'Bapenda Provinsi Sul-Sel',
    customerEmail: 'keuangan@bapenda-sulsel.go.id',
    customerPhone: '+62 812-421-9901',
    customerAddress: 'Kota Makassar, Sulawesi Selatan',
    dueDate: '22/09/2026',
    departureDate: '25/10/2026',
    packageCode: 'PKT-D814659D',
    packageName: 'Paket Umrah',
    packageDescription: 'Umrah 9 Hari (Reguler Silver)\nPKT-D814659D',
    paxCount: 3,
    pricePerPax: 36800000,
    discount: 0,
    taxRate: 0,
    ...
    paymentStatus: 'draft',
    paymentMethodDetails: 'Belum ada pembayaran',
    notes: 'Rombongan kloter 2 Bapenda Sul-Sel.',
    createdAt: '18 September 2026',
    termsAndConditions: '',
  },
];
