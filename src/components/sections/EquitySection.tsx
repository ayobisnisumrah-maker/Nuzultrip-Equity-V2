...
import { StatisticItem } from '../../data/landingData';
...
export const EquitySection: React.FC<EquitySectionProps> = ({
  ...
  const dynamicMetrics: StatisticItem[] = [
    {id:'porsi-ditawarkan',value:equityPercentage,suffix:'%',label:cms?.metric_equity_label||''},
    {id:'total-unit',value:totalUnits,suffix:' Unit',label:cms?.metric_units_label||''},
    {id:'porsi-per-unit',value:unitOwnership,suffix:'%',decimals:1,label:cms?.metric_unit_share_label||''},
    {id:'nilai-per-unit',value:pricePerUnit/1000000,prefix:'Rp. ',suffix:' Juta',label:cms?.metric_price_label||''},
    {id:'total-nilai',value:(totalUnits*pricePerUnit)/1000000000,prefix:'Rp. ',suffix:' Miliar',decimals:1,label:cms?.metric_total_label||''},
    {id:'periode-distribusi',value:0,customDisplay:cadenceMonths?(`Setiap ${cadenceMonths} bulan`):'—',label:cms?.metric_distribution_label||''},
  ];
  return (
    <section
      id="peluang"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-stretch">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between h-full">
            ...
            <div className="pt-8 sm:pt-10 mt-auto flex flex-col sm:flex-row lg:flex-col items-start gap-3">
              ...
              >
                <span>{cms?.calculator_cta_label || ''}</span>
              </a>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 flex flex-col h-full">
            <div className="relative w-full h-full min-h-[420px] sm:min-h-[480px] rounded-2xl overflow-hidden shadow-lg border border-black/10 flex flex-col justify-between p-6 sm:p-7 text-white group">
              ...
              <div className="relative z-10 pt-6">
                ...
                >
                  <span>{cms?.interest_cta_label || ''}</span>
